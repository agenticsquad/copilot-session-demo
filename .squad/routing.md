...
|-----------|----------|----------|
| Session structure, story arc, scope | Rusty | Outline the session, decide what stays/goes, review flow |
| Script, narrative, talking points | Saul | Write the session script, demo narration, transitions |
| Demo code, repo setup, user stories | Basher | Build demo app, create GitHub issues, configure agents/MCPs |
| Slides, PowerPoint, visual design | Livingston | Design slides, apply GitHub branding, create diagrams |
| Code review | Rusty | Review PRs, check quality, suggest improvements |
| Testing, QA, demo validation | Linus | Validate demos, review coherence, check timing |
